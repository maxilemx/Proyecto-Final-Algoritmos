...
def _normalizar_columnas(df):
    ...
    sin importar si el CSV las trae con guion, espacio, guion bajo o pegadas
    (p. ej. 'Sub Category', 'Subcategory' o 'Sub-Category' -> 'Sub-Category').
    Distintas versiones del dataset Superstore las escriben distinto."""
    canon = {
        ...
        "subcategory": "Sub-Category", "productname": "Product Name",
